...
export const MESSAGES = {
  ...
  RESET_CONFIRM: 'Are you sure you want to reset the application? This will remove your password but keep your encrypted notes.',
  ...
  FIRST_TIME_SETUP: 'Welcome! Please complete the initial setup to get started.',
};
